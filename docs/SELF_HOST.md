...
| `X402_ENABLED`, `X402_ENTRY_USDC_ATOMIC`, `X402_FACILITATOR_URL`, `X402_FACILITATOR_BEARER` | optional standard x402 v2 agent door; keep disabled until a funded mainnet smoke |
