...
const RELEASE = {"schema":1,"url":"https://raw.githubusercontent.com/3esign/ratchetx/main/releases/g2-agent-runtime.json.gz","sha256":"5db8e09adb62f99e3fc69ef9d0687fa36e38641449c4900477a75639e9931742","bytes":326209,"entry":"skills/ratchetx-g2/scripts/g2-session.mjs"};
...
export async function install({ archiveFile, home = process.env.RATCHET_G2_HOME || path.join(os.homedir(), '.ratchetx-g2'), dryRun = false,
  ...
  if (archiveFile) {
    ...
    fail(/^https:\/\/raw\.githubusercontent\.com\/3esign\/ratchetx\/main\/releases\/g2-agent-runtime\.json\.gz$/.test(release.url), 'UNSAFE_PACKAGE_URL');
