...
- DEX: PumpSwap
- Token: RatchetX (RCX)
- Mint / CA: `FQb2EyaLZ9TWBemYmQ9zWtXcEwLiSXtz7j619ThQpump`
- Pair: `3gbSEBMBbfqrC7wT7craJNkUhxNTBFyNjhrmedcHJusV`
- Page: https://dexscreener.com/solana/3gbsebmbbfqrc7wt7crajnkuhxntbfynjhrmedchjusv

DEXScreener already lists the pair automatically. The paid product needed now is
Enhanced Token Info, not a new token listing.
...
> RATCHET is a keyless prediction arcade on Solana. Players fire sealed
> commit-reveal shots at market outcomes settled from on-chain Pyth price
> accounts. Every verified RCX reload follows the same public rule: 70% is
> burned, 30% is paid directly to the live player podium, and 0% goes to the
> team. Wallets keep custody; the server holds no player funds or private keys.
> The game, state export, event record, reward receipts and proof page are public.
