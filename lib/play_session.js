...
function discoverySnapshot(w, record, observedAt) {
  try {
    ...
    if (!record || !g || g.wallet!==w || g.domain!==DOMAIN || g.network!==NETWORK
      ...
      || !l || !integer(l.maxAttempts,1,100) || !integer(l.maxStakeCredits,100,10000)
      || !integer(l.maxGrossCredits,l.maxStakeCredits,100000) || !integer(l.minIntervalMs,5000,600000)
