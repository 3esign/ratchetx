...
This source tree declares `h96-2026-08-30` through `lib/release.js`. A deployment is release-consistent only when
both production domains return the same version:

```
https://ratchetx.xyz/api/game?action=state   ->  "v": "h96-2026-08-30"
https://ratchetx.xyz/api/proof               ->  "v": "h96-2026-08-30"
```
