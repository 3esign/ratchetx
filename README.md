...
```
https://ratchetx.vercel.app/api/game?action=state   ->  "v": "h10-2026-08-20"
https://ratchetx.vercel.app/api/proof               ->  "v": "h10-2026-08-20"
```

`api/game.js` and `api/proof.js` in this repo declare `const VERSION = 'h10-2026-08-20'`.
