...
<div class="card">
  ...
  ${[
    ...
    ['feed2', 'string|null', 'Second Pyth feed for a race question.'],
    ['kind', 'string|null', 'Sealed question type: dir, thr, thrDown, range or race.'],
    ...
    ['statedProbability', 'float|null', 'Probability stated for the caller\'s own side; used for Brier scoring.'],
    ...
    ['previousExitAt', 'ms|null', 'Pyth prev_publish_time retained for the selected update.'],
    ['previousExitAt2', 'ms|null', 'Equivalent evidence for the second race feed.'],
    ['exitConfidenceBps', 'float|null', 'Selected primary update confidence width in basis points.'],
    ...
    ['outcomeRule', 'string|null', 'Versioned outcome-comparison rule applied to this shot.'],
